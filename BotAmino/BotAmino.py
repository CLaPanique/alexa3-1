    ...
    def __init__(self, email: str = None, password: str = None, sid: str = None,  prox :dict =None ,proxies: dict = None, deviceId: str ="4211114976519E45A4AFFF169AAE77B818995C7AC5823F08C01D2B3116F4E773F3D354E491", certificatePath: str = None):
        ...
        if email and password:
            ...
            try:
                ...
                self.login(email=para[0].strip(), password=para[1].strip(),prox=prox)
        ...
        self.perms_list = ["501cc6f5-1e38-4a22-9df5-cd0625b0205e", "27ec9ed9-e349-4edc-b0ed-a01b7f8b85c7","816d376a-29f3-4964-aa52-998517905c2b","172eee02-5ef8-497e-9082-e36a38e13dac"]
        self.prefix = "!"
        self.activity = False
        self.wait = 0
        self.bio = None
